...
/// @dev ETHsign an API3 Token Delegation and Voting Policy, with reference to their own Delegation Disclosure, only if address has staked API3 in API3 governance contract
...
contract SignDelegationPolicy {
    ...
    /// @notice for msg.sender to check their current voting power in API3 governance
